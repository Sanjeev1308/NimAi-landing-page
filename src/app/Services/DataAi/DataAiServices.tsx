  ...
  const services: Service[] = [
    {
      ...
      description:
        "Advanced ML models tailored to your business needs, from predictive analytics to natural language processing.",
      features: [
    ...
    },
    {
      ...
      description:
        "Build robust data infrastructure that scales with your business, ensuring data quality and accessibility.",
      features: [
    ...
    },
    {
      ...
      title: "Analytics & BI",
      description:
        "Transform raw data into actionable insights with powerful analytics and intuitive dashboards.",
      features: [
    ...
    },
    {
      ...
      title: "AI Strategy",
      description:
        "Navigate your AI transformation journey with expert guidance and strategic planning.",
      features: [
    ...
    },
    {
      ...
      title: "Deep Learning",
      description:
        "Leverage cutting-edge deep learning techniques for complex problems like computer vision and speech recognition.",
      features: [
    ...
    },
    {
      ...
      description:
        "Streamline your ML operations with automated workflows, version control, and continuous deployment.",
      features: [
        "CI/CD for ML models",
        "Model versioning",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-20 pb-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Transform your business with intelligent data solutions and
              cutting-edge artificial intelligence. We turn complex data into
      ...
      <section className="container mx-auto px-4 py-20 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Comprehensive data and AI services designed to accelerate your
        ...
        <div className="glass rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss how our Data & AI solutions can drive innovation and
